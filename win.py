// я не умею и не знаю как пользоваться этим сайтом "гитхаб".

// скопировал код, создал репозиторий, но не знаю правильно ли это сделал, не знаю увидите вы ли это .

// первое что я понял что это пайтон, потому что файл заканчивается на ".ру"

// знаю еще "деф" в пайтоне означает функция.

// я думаю это наверняка какой-нибудь сайт, там какие-то параметры с размерами.

// по программированию я посмотри только несколько видео в ютубе а именно о solidity и phyton.

// все остальное ничего не понимаю. для меня это символы и я не понимаю ничего пока в этих кодах.
